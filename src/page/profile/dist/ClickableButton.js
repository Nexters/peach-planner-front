...
var ClickableButton = function (_a) {
    var items = _a.items, handleItems = _a.handleItems, content = _a.content;
    var _b = react_1.useState(false), isClicked = _b[0], setIsClicked = _b[1];
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Circle, { border: isClicked ? '1px solid #E64980' : '1px solid #ced4da', backgroundColor: isClicked ? '#E64980' : '', onClick: handleClick },
            React.createElement(style_1.Content, { height: '24px', width: 'auto', color: isClicked ? '#FFFFFF' : '#868E96', fontSize: '13px', lineHeight: '32px', margin: '9px 20px 9px 20px' }, content))));
};
