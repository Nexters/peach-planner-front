...
var planner1_png_1 = require("./dummy/planner1.png");
    ...
    return (React.createElement(style_1.FlexDiv, { margin: '54px 0 0 0', direction: "column" },
        ...
        React.createElement(style_1.FlexDiv, { margin: '0', justify: "flex-start", direction: "row" }, planners ? (planners.map(function (planner, index) {
            return (React.createElement(PlannerCard, { key: index },
                React.createElement(Image, { src: planner1_png_1["default"] }),
                React.createElement(Description, null, planner.description.split('\\n').map(function (line, index) {
                    return (React.createElement("span", null,
                        line,
                        React.createElement("br", null)));
                })),
                React.createElement(PlannerName, null,
                    planner.plannerName,
                    " \uD50C\uB798\uB108")));
...
var PlannerName = styled_components_1["default"].div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  height: 18px;\n  width: 240px;\n  color: #000000;\n  font-family: SpoqaHanSans;\n  font-size: 12px;\n  font-weight: bold;\n  letter-spacing: 0;\n  position: absolute;\n  line-height: 18px;\n  margin-left: 20px;\n  margin-top: 86px;\n"], ["\n  height: 18px;\n  width: 240px;\n  color: #000000;\n  font-family: SpoqaHanSans;\n  font-size: 12px;\n  font-weight: bold;\n  letter-spacing: 0;\n  position: absolute;\n  line-height: 18px;\n  margin-left: 20px;\n  margin-top: 86px;\n"])));
