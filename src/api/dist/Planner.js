...
exports.fetchPopularPlanners = function (_a) {
    var queryKey = _a.queryKey;
    return __awaiter(void 0, void 0, void 0, function () {
        var _key, params, data;
        return __generator(this, function (_b) {
...
exports.fetchRecommendedPlanners = function (_a) {
    var queryKey = _a.queryKey;
    return __awaiter(void 0, void 0, void 0, function () {
        var _key, params, data;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _key = queryKey[0], params = queryKey[1];
                    return [4 /*yield*/, axios_1["default"].get('/planners/recommended')];
                case 1:
                    data = (_b.sent()).data;
                    return [2 /*return*/, data];
            }
...
exports.fetchPlanner = function (plannerId) { return __awaiter(void 0, void 0, void 0, function () {
    var data;
...
exports.fetchPlannerPartners = function (plannerId) { return __awaiter(void 0, void 0, void 0, function () {
    var data;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
exports.updateProfile = function (plannerRequest) { return __awaiter(void 0, void 0, void 0, function () {
    var data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1["default"].post("planners", plannerRequest, {
                    headers: {
