    ...
    return (React.createElement(style_1.FlexDiv, { margin: '54px 0 0 0', direction: "column" },
        ...
        React.createElement(style_1.FlexDiv, { margin: '0', justify: "flex-start", direction: "row" }, planners ? (planners.map(function (planner, index) {
            ...
            return (React.createElement(PlannerCard, { key: index },
                ...
                planner.fontColor === 'WHITE' ? (React.createElement(WhiteDescription, null, (_a = planner.description) === null || _a === void 0 ? void 0 : _a.split('\\n').map(function (line, index) {
                    return (React.createElement("span", { key: index },
                        line,
                        React.createElement("br", null)));
                }))) : (React.createElement(Description, null, (_b = planner.description) === null || _b === void 0 ? void 0 : _b.split('\\n').map(function (line, index) {
                    return (React.createElement("span", { key: index },
                        line,
                        React.createElement("br", null)));
                }))),
