...
import { getUserMe, EditUserInfo, DeleteUser, User } from 'lib/api/User';
      ...
      <InnerContainer>
        ...
        {changePw ? (
          <FlexDiv direction="column" margin="0 40px" justify="flex-start">
            <SettingBox>
              <AlignCenterBox>
                <div style={{ cursor: 'pointer' }}><Image src={LeftArrow} layout='fixed' onClick={() => setChangePw(false)} /></div>
