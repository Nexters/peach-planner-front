...
var UserMyPage = function () {
    ...
    var _b = react_1.useState(), slider = _b[0], setSlider = _b[1];
    var _c = react_1.useState({
        ...
        variableWidth: true,
        arrows: false
    }), slickSettings = _c[0], setSlickSettings = _c[1];
        ...
        React.createElement(InnerContainer, null,
            ...
            React.createElement(ContentContainer, null,
                React.createElement(PickTitleBox, null,
                    ...
                    React.createElement(style_1.FlexDiv, { justify: "flex-end" }, ((_a = picks === null || picks === void 0 ? void 0 : picks.pickLists) === null || _a === void 0 ? void 0 : _a.length) > 6 ? (React.createElement(React.Fragment, null,
                        ...
                        React.createElement(ArrowButton, { src: ic_arrow_right_svg_1["default"], onClick: slider === null || slider === void 0 ? void 0 : slider.slickNext, margin: "0" }))) : (React.createElement(React.Fragment, null)))),
                React.createElement(PickListBox, { style: { overflow: 'hidden' } }, (function () {
                    if (picks !== undefined && picks.pickLists.length <= 6) {
                        return picks.pickLists.map(function (pick) {
                        ...
                        return (React.createElement(Slider, __assign({}, slickSettings, { ref: function (ref) { return setSlider(ref); } }), picks ? (picks === null || picks === void 0 ? void 0 : picks.pickLists.map(function (pick) {
                            return (React.createElement(PlannerMiniCard_1["default"], { key: pick.id, id: pick.id, size: "130px", image: pick.imageUrlPath, plannerName: pick.name, companyName: pick.subName, margin: '0 16px 0 0' }));
