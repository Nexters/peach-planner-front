    ...
    return (React.createElement(style_1.FlexDiv, { justify: "flex-start", margin: "0 0 0 0" },
        React.createElement(Box, null,
            React.createElement(style_1.FlexDiv, { margin: "0", direction: "column" },
                ...
                React.createElement(UserType_1["default"], { type: type, textHeight: "19px", typeHeight: "22px", fontSize: "13px", lineHeight: "19px" }),
...
var ProfileImage = styled_components_1["default"].img.attrs(function (props) { return ({ src: props.src }); })(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  height: 124px;\n  width: 124px;\n  margin: 0;\n  border-radius: 100%;\n  position: relative;\n"], ["\n  height: 124px;\n  width: 124px;\n  margin: 0;\n  border-radius: 100%;\n  position: relative;\n"])));
var EditIcon = styled_components_1["default"].img.attrs(function (props) { return ({ src: props.src }); })(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  box-sizing: border-box;\n  height: 41px;\n  width: 41px;\n  border: 1px solid #ffffff;\n  background-color: #f1f3f5;\n  border-radius: 100%;\n  position: absolute;\n  cursor: pointer;\n"], ["\n  box-sizing: border-box;\n  height: 41px;\n  width: 41px;\n  border: 1px solid #ffffff;\n  background-color: #f1f3f5;\n  border-radius: 100%;\n  position: absolute;\n  cursor: pointer;\n"])));
